 ...
 * Package com.m1.sg.bcc.om.database.poller.configuration
 * Description: This class created for configure time interval low priority poller spring integration framework 
 * Modification Log:
...
public class OMLowPriorityPollerTriggerConfiguration implements Trigger {

	/**
	 * 	For the Low priority poller configuration
	 * 
	 * 	poller configuration retrieve all properties attribute define in the spring framework properties element
	 * 	for this class we use properties LOW_PRIORITY_DEFAULT_TIME_INTERVAL for default value time interval 
	 */
	...
	public Date nextExecutionTime(TriggerContext triggerContext) {
		...
		Integer defaultValue = Integer.valueOf(pollerPropertiesConfiguration.getProperty(OMPollerConstant.PropertiesAttribute.LOW_PRIORITY_DEFAULT_TIME_INTERVAL.getValue()));
