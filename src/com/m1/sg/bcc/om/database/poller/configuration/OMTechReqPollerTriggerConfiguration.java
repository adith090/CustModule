...
public class OMTechReqPollerTriggerConfiguration implements Trigger {
	...
	public Date nextExecutionTime(TriggerContext triggerContext) {
		...
		Integer defaultValue = Integer.valueOf(pollerPropertiesConfiguration.getProperty(OMPollerConstant.PropertiesAttribute.TECHREQ_DEFAULT_TIME_INTERVAL.getValue()));
