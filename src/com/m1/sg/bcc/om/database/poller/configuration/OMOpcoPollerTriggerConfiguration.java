...
public class OMOpcoPollerTriggerConfiguration implements Trigger {
	...
	public Date nextExecutionTime(TriggerContext triggerContext) {
		...
		Integer defaultValue = Integer.valueOf(pollerPropertiesConfiguration.getProperty(OMPollerConstant.PropertiesAttribute.OPCO_DEFAULT_TIME_INTERVAL.getValue()));
