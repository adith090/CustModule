 ...
 * Package com.m1.sg.bcc.om.database.poller.configuration
 * Description: This class created for configure time interval high priority poller spring integration framework 
 * Modification Log:
...
public class OMHighPriorityPollerTriggerConfiguration implements Trigger {

	/**
	 * 	For the High priority poller configuration
	 * 
	 * 	poller configuration retrieve all properties attribute define in the spring framework properties element
	 * 	for this class we use properties HIGH_PRIORITY_DEFAULT_TIME_INTERVAL for default value time interval 
	 */
	...
	public Date nextExecutionTime(TriggerContext triggerContext) {
		...
		Integer defaultValue = Integer.valueOf(pollerPropertiesConfiguration.getProperty(OMPollerConstant.PropertiesAttribute.HIGH_PRIORITY_DEFAULT_TIME_INTERVAL.getValue()));
